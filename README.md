...
> Kubeapps ChartSvc is a core component of Kubeapps, a Web-based application deployment and management tool for Kubernetes clusters.
...
* `1.0.1-scratch-r0`, `1.0.1-scratch`, `1.0.1-r0`, `1.0.1`, `1`, `latest` [1/scratch/Dockerfile](https://github.com/bitnami/bitnami-docker-kubeapps-chartsvc/blob/1.0.1-scratch-r0/1/scratch/Dockerfile)
